...
namespace Cumulative2.Controllers
{
    public class ClassDataController : ApiController
    {
        ...
        //This controller accesses the classes table of the school database.
        /// <summary>
        ...
        public List<Class> ListClasses(string ClassSearchKey)
        {
            ...
            while (ResultSet.Read())
            {
                ...
                DateTime StartDate = (DateTime)ResultSet
                ["startdate"];

                //get class finish date
                DateTime FinishDate = (DateTime)ResultSet
                ["finishdate"];

                //get class name
                string ClassName = (ResultSet)
                ["classname"].ToString();
